...
then
    ...
    docker build -t user:$IMAGE_TAG .
    docker tag user:$IMAGE_TAG 482053628475.dkr.ecr.eu-central-1.amazonaws.com/usupport-user-api:$IMAGE_TAG

    # Push image to 
    docker push 482053628475.dkr.ecr.eu-central-1.amazonaws.com/usupport-user-api:$IMAGE_TAG
