...
export const getAllActiveCountries = async () =>
  await getDBPool("masterDb").query(
    `
      SELECT "country"."country_id", "country"."name", "country"."alpha2", "country"."alpha3", "country"."is_active","country"."min_client_age", "country"."max_client_age", "currency"."currency_id", "currency"."name" AS "currency_name", "currency"."code", "currency"."symbol", "currency"."min_price"
      FROM "country"
