export default {
  email_or_access_token_required_error:
    "Aby się zarejestrować, należy podać adres email lub ważny token dostępu użytkownika",
  ...
  invalid_platform_password_error: "Nieprawidłowe hasło dostępu do platformy",
  no_platform_password_set_error:
    "Hasło dostępu do platformy nie zostało jeszcze ustawione",
